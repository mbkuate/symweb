...
class AdType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('coverImage', 
                UrlType::class, 
                $this->getConfiguration("URL de l'image principale", "Donnez l'adresse d'une image qui dnne vraiment envie")
            )
            ...
            ->add('rooms', 
                IntegerType::class, 
                $this->getConfiguration("Nomdre de chambres", "Le nombre de chambres disponibles")
            )
